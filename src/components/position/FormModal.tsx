...
const FormModal = ({ id, type, title, isOpen, setIsOpen, closeModal, themeClass = "bg-slate-900 dark:bg-slate-800 dark:border-b dark:border-slate-700", fetchPosition }: any) => {
                    ...
                    <div className={`flex min-h-full justify-center text-center p-6 items-start`}>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <FormPosition close={closeModalHandle} type={type} id={id} />
                                </div>
                            </Dialog.Panel>
                        </Transition.Child>
                    </div>
